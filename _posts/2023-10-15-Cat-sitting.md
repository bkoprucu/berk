...
Stove will be hot for a while after cooking. **Never leave the hot stove uncovered.**

Put a lid or another pot to cover it while moving away a hot pan.
...
For wet food, use a clean flat plate for each use:
...
Kucuk demands more food during the day. You may give her some kibble. If Pamuk is inside, you'll have to give him too, but much less. 

Note there are different kinds of kibble in each box:

{%- include image.html url="/assets/images/posts/cat-sitting/kibble_boxes.webp" description="Different kind of kibble in each box" height="360px" -%}
...
I crushed Pamuk's pills and put their dust in little glasses, as shown in the picture below:
...
Every other day, pour one glass on his wet food.

## Litter box
- There should not be more than 3 centimeters pellet litter in the box.
- There is a bottom tray and meshed container on top, which lets the pee flow to the bottom tray.
- Some natural clamping litter (not pellet) in the bottom tray prevents the smell. A bit of baking soda on top of it can be useful too.
- For couple days no cleaning is usually needed. You may take the turd from top with the shovel and stir the litter a bit.
- After couple days, you may remove the clamped litter from the bottom tray. 
...
Especially Kucuk, demands brushing, but Pamuk needs it more. 


## Much Meowing?

Esp. Kucuk can be demanding. The reasons might be:

- Kucuk eats in small portions and wants to snack some kibble. There are two kinds of kibble in each box, she might want a different kind this time.
- Boredom. Kucuk enjoys brushing, petting and chasing the laser pointer (black device by TV). You may also put the cardbox on the ottoman and put her inside. Pamuk usually just wants to go out. You may open the bedroom window for both of them to observe.
- Litter box is either dirty, or bathroom door is closed.
- Kucuk couldn't get under duvet, where she sleeps.

{%- include image.html url="/assets/images/posts/cat-sitting/laser_pointer.webp" description="Laser pointer and brush" height="350px" -%}
...
{%- include image.html url="/assets/images/posts/cat-sitting/lights_remote.webp" description="Top two buttons switches lights in the main room" height="360px" -%}

- Top two buttons on the remote switches the stand lights in the main room. 

- Turning ceiling lights on and off swiftly changes their brightness level in three steps.

Kitchen counter light switch is right above the soap dispenser: 

{%- include image.html url="/assets/images/posts/cat-sitting/kitchen_light.webp" description="Light switch is right above the soap dispenser" height="360px" -%}
...
- Soap box emits toxic gas, therefore it has to be kept in its cabinet, away from food.

![](/assets/images/posts/cat-sitting/dishwasher_soap.jpeg)

### Garbage
{%- include image.html url="/assets/images/posts/cat-sitting/garbage.webp" description="Shopping bags on the right" height="350px" -%}

Garbage bins for metal (top left), glass and plastics (top right), mixed (bottom left) and organic waste (bottom right).

I use egg cartoons (on top of the metal bin in the photo), to place under the organic bin, so that they soak any liquid leaks.

Only pure and clean paper is recycled, like newspapers and such. They are inside the leftmost cabinet (not in the picture). Pamuk likes to go inside of it.
